...
\indent 对于上面的三个服务，首先通过\texttt{kubectl apply -f \${deployment}}来部署实例，然后
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.65\textwidth}
        \centering
        \includegraphics[width=\textwidth]{redisleader.png}
        \caption{redis-leader的信息}
        \label{fig:redisleader}
    \end{subfigure}
\end{figure}

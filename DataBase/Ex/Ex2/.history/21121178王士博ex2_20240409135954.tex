...
\begin{minipage}[H]{0.45\textwidth}
    \begin{figure}[H]
        \includegraphics[width=1\textwidth]{dockerhelloworld.png}
        \caption{docker安装}
    \end{figure}
\end{minipage}
\hfill
\begin{minipage}[H]{0.45\textwidth}
    \begin{subfigure}[t]
        \includegraphics[width=\textwidth]{changeorigin.png}
        \caption{docker hello-world}
    \end{subfigure}

    \begin{subfigure}[t]
        \centering
        \includegraphics[width=\textwidth]{kubernetesverify.png}
        \caption{kubernetes-verificatio}
    \end{subfigure}
\end{minipage}

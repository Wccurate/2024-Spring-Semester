...
\begin{figure}[ht]
    \centering
    \begin{subfigure}[b]{0.4\textwidth} % Here [b] aligns the subfigure at the bottom, and {0.4\textwidth} sets the width of the subfigure
        \centering
        \includegraphics[width=\textwidth]{client_login_ssh.png} % Here \textwidth refers to the width set by the subfigure environment
    ...
    \end{subfigure}
    \caption{无密码SSH登录的示例} % Optional overall caption for all subfigures
\end{figure}

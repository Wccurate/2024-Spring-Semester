...
\end{center}
    ...
    \begin{lstlisting}
        ...
        CUDA_PATH_V11_6_BIN = C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.6\bin
        CUDA_PATH_V11_6_LIB = C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.6\lib\x64
        CUDA_PATH_V11_6_INCLUDE = C:\Program Files\NVIDIA GPU Computing Toolkit\CUDA\v11.6\include
    \end{lstlisting}
\end{enumerate}
\section{实验感想}

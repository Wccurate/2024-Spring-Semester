...
\begin{table}[ht]
    ...
    \hline
    \multirow{2}{*}{Config} & \multicolumn{4}{c|}{Size} \\ \cline{2-5}
                            & 1000 & 2000 & 3000 & 4000 \\ \hline
    init omp                & 数据 & 数据 & 数据 & 数据 \\ \hline
    cont omp                & 数据 & 数据 & 数据 & 数据 \\ \hline
    cont cuda               & 数据 & 数据 & 数据 & 数据 \\ \hline
    1                       & 数据 & 数据 & 数据 & 数据 \\ \hline
    2                       & 数据 & 数据 & 数据 & 数据 \\ \hline
    3                       & 数据 & 数据 & 数据 & 数据 \\ \hline
    \end{tabular}

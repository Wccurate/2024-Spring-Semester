...
\end{center}
    \begin{enumerate}
        \item 访问NVIDIA官网，下载适用于自己操作系统的CUDA Toolkit。CUDA Toolkit是一个用于开发CUDA程序的软件包，包含了CUDA编译器、CUDA库、CUDA工具等。下载地址：\url{https://developer.nvidia.com/cuda-toolkit-archive}。

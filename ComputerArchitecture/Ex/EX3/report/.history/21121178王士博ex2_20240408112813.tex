...
乘法的阶段的最后结果的每一个元素的计算都是相互独立的
\begin{table}[H]
    \centering
    \begin{tabular}{|l|c|c|c|c|}
    \hline
    \multicolumn{2}{|l|}{Config} & 1 & 2 & 3 & 4 \\ \hline
    \multirow{4}{*}{OMP} & init omp & 数据 & 数据 & 数据 & 数据 \\ \cline{2-6}
                          & cont omp & 数据 & 数据 & 数据 & 数据 \\ \cline{2-6}
                          & cont cuda & 数据 & 数据 & 数据 & 数据 \\ \cline{2-6}
    \multirow{3}{*}{Etc} & 1 & 数据 & 数据 & 数据 & 数据 \\ \cline{2-6}
                          & 2 & 数据 & 数据 & 数据 & 数据 \\ \cline{2-6}
                          & 3 & 数据 & 数据 & 数据 & 数据 \\ \hline
    \end{tabular}

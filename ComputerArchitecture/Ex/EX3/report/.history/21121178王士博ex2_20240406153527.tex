...
\begin{table}[ht]
    ...
    \hline
    \textbf{Matrix Size} & \textbf{1 Thread} & \textbf{2 Threads} & \textbf{4 Threads} & \textbf{8 Threads} & \textbf{16 Threads} & \textbf{32 Threads} \\ \hline
    \textbf{macOS (8 cores)} & 1000 & 2000 & 3000 & ... & ... & ... \\ \hline
    \textbf{Windows (16 logical cores)} & 1000 & 2000 & 3000 & ... & ... & ... \\ \hline
    \end{tabular}
    \caption{Performance metrics for different thread counts on macOS and Windows for various matrix sizes.}
    \end{table}
\subsection{}
\subsection{}
\section{实验感想}

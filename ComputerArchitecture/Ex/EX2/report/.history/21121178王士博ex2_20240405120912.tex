...
\begin{minipage}
    \begin{mycolorbox}
        \lstinputlisting[style=cstyle]{../src/helloworld.c}
    \end{mycolorbox}
    \begin{mycolorbox}
        \lstinputlisting[style=cstyle]{../src/matrix.c}
    \end{mycolorbox}
    \begin{mycolorbox}
        \lstinputlisting[style=cstyle]{../src/pi.c}
    \end{mycolorbox}
    \begin{mycolorbox}
        \lstinputlisting[style=cstyle]{../src/parallel_pi.c}
    \end{mycolorbox}
    \begin{mycolorbox}
        \lstinputlisting[style=cstyle]{../src/parallel_pi_2.c}
    \end{mycolorbox}
    \begin{mycolorbox}
        \lstinputlisting[style=cstyle]{../src/parallel_pi_3.c}
    \end{mycolorbox}
    \begin{mycolorbox}
        \lstinputlisting[style=cstyle]{../src/parallel_pi_4.c}
    \end{mycolorbox}
    \begin{mycolorbox}
        \lstinputlisting[style=cstyle]{../src/parallel_pi_5.c}
    \end{mycolorbox}
    \begin{mycolorbox}
        \lstinputlisting[style=cstyle]{../src/parallel_pi_6.c}
    \end{mycolorbox}
    \begin{mycolorbox}
        \lstinputlisting[style=cstyle]{../src/parallel_pi_7.c}
    \end{mycolorbox}
    \begin{mycolorbox}
        \lstinputlisting[style=cstyle]{../src/parallel_pi_8.c}
    \end{mycolorbox}
    \begin{mycolorbox}
        \lstinputlisting[style=cstyle]{../src/parallel_pi_9.c}
    \end{mycolorbox}
    \begin{mycolorbox}
        \lstinputlisting[style=cstyle]{../src/parallel_pi_10.c}
    \end{mycolorbox}
    \begin{mycolorbox}
        \lstinputlisting[style=cstyle]{../src/parallel_pi_11.c}
    \end{mycolorbox}
    \begin{mycolorbox}
        \lstinputlisting[style=cstyle]{../src/
\end{minipage}
\end{document}
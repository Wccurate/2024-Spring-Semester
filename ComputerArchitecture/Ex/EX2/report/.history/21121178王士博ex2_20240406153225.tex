...
\begin{table}[ht]
    ...
    \hline
    & \textbf{1 Thread} & \textbf{2 Threads} & \textbf{4 Threads} & \textbf{8 Threads} & \textbf{16 Threads} & \textbf{32 Threads} \\ \hline
    \textbf{1000} & MacOS / Windows & MacOS / Windows & MacOS / Windows & MacOS / Windows & MacOS / Windows & MacOS / Windows \\ \hline
    \textbf{2000} & MacOS / Windows & MacOS / Windows & MacOS / Windows & MacOS / Windows & MacOS / Windows & MacOS / Windows \\ \hline
    \textbf{3000} & MacOS / Windows & MacOS / Windows & MacOS / Windows & MacOS / Windows & MacOS / Windows & MacOS / Windows \\ \hline
    \end{tabular}
    \caption{Performance metrics for matrix sizes 1000, 2000, and 3000 across different thread counts on MacOS and Windows.}
    \end{table}
\subsection{}
\subsection{}
\section{实验感想}
